...
假设*p*真的等于 0.5（即<math><msub><mi>H</mi> <mn>0</mn></msub></math>为真），我们只有 5%的机会观察到一个落在这个区间之外的*X*，这正是我们想要的显著性水平。换句话说，如果<math><msub><mi>H</mi> <mn>0</mn></msub></math>为真，那么大约有 20 次中有 19 次这个测试会给出正确的结果。

...
现在我们有了选择器，我们可以使用D3的`on`方法来附加一个事件处理回调函数，当选择器被改变时触发：
...
[![1](assets/1.png)](#co_the_menu_bar_CO4-1)
...
[![1](assets/1.png)](#co_the_menu_bar_CO5-1)
...
[![1](assets/1.png)](#co_the_menu_bar_CO6-1)
...
[![1](assets/1.png)](#co_the_menu_bar_CO8-1)

...
^(3) 如果你遇到问题，可以尝试在[JSONLint 的验证器](https://jsonlint.com)中验证你的数据，以获得更好的反馈。

^(4) D3 支持多种其他数据格式，如分层（树状）数据或节点和链接图格式。这里有一个[a tree hierarchy specified in JSON](https://oreil.ly/WsBCI)的示例。

...
[![1](assets/1.png)](#co_restful_data_with_flask_CO1-1)
...
[![1](assets/1.png)](#co_restful_data_with_flask_CO6-1)
...
[![2](assets/2.png)](#co_restful_data_with_flask_CO10-2)
...
配置文件已就位后，我们可以通过从命令行运行`create`来创建一个Heroku应用程序。

...
^(1) 您可以在[GitHub](https://oreil.ly/I0FMA)上找到有关该软件包的更多信息，包括我们在设计此蓝图时使用的使用指南。

^(2) Sansiri Tarnpradab 等人提出了一种通过层次注意力网络实现在线论坛讨论摘要的方法。[*https://arxiv.org/abs/1805.10390*](https://arxiv.org/abs/1805.10390)。也可以查看[数据集（*.zip*）](https://oreil.ly/cqU_O)。

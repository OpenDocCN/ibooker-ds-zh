...
^(2) 要了解更详细的描述，请参阅[Wikipedia 页面](https://oreil.ly/yr5yA)。

^(3) pyLDAvis 必须单独安装，使用**`pip install pyldavis`**或**`conda install pyldavis`**。

^(4) 参见，例如，安德烈·A·沙巴林的[k-means 聚类页面](https://oreil.ly/OTGWX)或纳夫塔利·哈里斯的[“可视化 K-Means 聚类”](https://oreil.ly/Po3bL)。

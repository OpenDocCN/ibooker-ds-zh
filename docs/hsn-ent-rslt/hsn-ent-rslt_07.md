...
这样我们得到了四个群集。与ID 0、1和3关联的实体被分组在群集0中，因为它们具有完全相同的名称拼写，而ID 2、4和5具有唯一的拼写变体，因此分配了它们自己的个体群集，正如我们在[图7-2](#fig-7-2)中所见。
...
在经过消除姓名和出生年月信息后的结果表格中，我们可以在[图7-10](#fig-7-10)中以表格形式看到一些选定的群集。

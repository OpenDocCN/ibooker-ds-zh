...
虽然这相当简单明了，但如何开始使用Jupyter的说明可在[文档](https://docs.jupyter.org/en/latest)中找到。
...
我们已成功解决了两个数据集之间的姓名冲突，所以现在我们可以使用合并后的信息来验证我们关于社交媒体存在与议员连任可能性相关性的假设。我们解决后的数据现在在一个表格中包含了我们需要的所有信息。[图2-12](#fig-2-12)展示了这个表格的前几行。

...
我们将继续使用掷骰子的示例。这被认为是*离散*概率分布，因为结果是可数的：例如，掷骰子可能会得到2或3，但永远不可能得到2.25。
...
![在Excel中展示的经验法则](assets/aina_0206.png)
...
[图 2-9](#different-normal-distributions)展示了两个具有不同均值和标准差的正态分布。尽管它们的形状非常不同，它们仍然遵循经验法则。
